...
import Login from "../Login/StudentsLogin"
import RegisterStudents from '../../classes/registerStudents.class';
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6}>
                                <TextField
                                    ...
                                    required
                                    fullWidth
                                    value={fullName} onChange={(e)=>{ console.log(e.target); setFullName(e.target.value)}}
                                    id="fullName"
                                    label="Full Name"
                                    autoFocus
                                />
                        ...
                        <Button
                            ...
                            onClick={(e)=>{
                                ...
                                if (validation()) {
                                    ...
                                    const newStudents = new RegisterStudents(fullName,userName,email,password,profileImg)
